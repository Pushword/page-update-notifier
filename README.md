...
Get an email when new words (page) are pushed (create/edit) on your Pushword CMS.
...
Visit [pushword.piedweb.com](https://pushword.piedweb.com/extension/page-update-notifier)
